package com.example.system__cccd.controller;
import com.example.system__cccd.dto.sampleDTO;
...
import com.example.system__cccd.service.sampleService;
...
//            return ResponseEntity.status(HttpStatus.OK).body("manager.html");
//        } else {
//            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).build();
//        }
//    }
